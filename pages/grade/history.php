      ...
      <div class="row">
          ...
          <div class="row">
            ...
            <div class="box-header">
              ...
              <a href="temp_record.php?sy=<?php echo $schoolyear; ?>&sem=<?php echo $sem; ?>&stud=<?php echo $_GET['stud_id']; ?>"  class="btn btn-md btn-primary pull-right">View Permanent Record</a>
            </div>
            <div class="box-body">
